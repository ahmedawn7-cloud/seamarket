...
export default function AccessGate({
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-8 text-center shadow-2xl shadow-black/20">
      ...
      <button
        onClick={onLogin}
        className="mt-6 rounded-full bg-cyan-500 px-6 py-3 font-bold text-foreground transition hover:bg-cyan-300"
      >
